...
const Header = () => {
  ...
  return (
    <div
      ref={headerRef}
      className="w-11/12 max-w-3xl text-center mx-auto flex flex-col items-center justify-center gap-3 pt-28 pb-16 relative z-10"
    >
      <motion.div
        initial={{ scale: 0 }}
        whileInView={{ scale: 1 }}
      ...
      >
        I am Web Developer From Uttrakhand India, doing Multiple Things Like Web
        Development, Cloud Computing, and also Open Source Contributor.
      </motion.p>
